    ...
    return this.state.loading ? (
      ...
      <div className="container">
        ...
        <div className="addEventBanner">
          <h2 className="homeHeaderContentTitle">Add a New Event</h2>
          <h3 className="homeHeaderContentSubtitle">
            Create an Event for your Space
          </h3>
        </div>
        <main className="spaceSignUpMain">
          <h4 className="spaceSignUpTitle">Event Information</h4>
          <div className="spaceSignUpContainer">
            ...
            <div
              style={{
                ...
                flexDirection: "row",
                alignItems: "center",
                marginBottom: changeLocation ? 16 : 72
              }}
            >
              <input
                id="newSponsors"
                type="checkbox"
                onKeyDown={e =>
                  e.keyCode === 13 ? this.changeLocation() : null
                }
            ...
            {this.state.challenges.map((challenge, i) => (
              <div
                className="eventChallengeBlock"
                style={{ marginTop: "15px" }}
                key={i}
              >
                <TextField
                  label="Challenge Title"
                  onChange={event => this.handleChallengeTitle(i, event)}
                  type="text"
                  margin="normal"
                  style={{ width: "100%" }}
                />
                <Editor
                  ...
                  onEditorStateChange={editorState =>
                    this.handleChallengeContent(i, editorState)
                  }
